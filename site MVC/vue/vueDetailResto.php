...
<ul id="critiques">
    ...
    <?php if (isset($_SESSION["mailU"])) { ?>
            <li>
                <form action="./?action=modifierCritique&idR=<?= $unResto["idR"]; ?>" method="post">
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="commentaire" id="commentaire" rows="3" required></textarea>
                    </div>
                    <div>
                        <button type="submit">Ajouter une critique</button>
                    </div>
                </form>
            </li>
    <?php } ?>
